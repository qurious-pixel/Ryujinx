...
curl -sL https://raw.githubusercontent.com/$GITHUB_REPOSITORY/$BRANCH/Ryujinx/Ui/assets/Ryujinx.svg -o AppDir/Ryujinx.svg
curl -sL https://raw.githubusercontent.com/$GITHUB_REPOSITORY/$BRANCH/Ryujinx.desktop -o AppDir/Ryujinx.desktop
curl -sL https://raw.githubusercontent.com/$GITHUB_REPOSITORY/$BRANCH/.travis/update.sh -o AppDir/update.sh
curl -sL https://raw.githubusercontent.com/$GITHUB_REPOSITORY/$BRANCH/.travis/AppRun -o AppDir/AppRun
